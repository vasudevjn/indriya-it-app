...
export default function TechnicianProfile() {
  ...
  const badgeColors = isApproved
    ? {
        bg: theme.statusColors.resolved.bg,
        border: theme.statusColors.resolved.accent,
        text: theme.statusColors.resolved.text,
        label: 'Approved',
      }
    : {
        bg: theme.statusColors.in_progress.bg,
        border: theme.statusColors.in_progress.accent,
        text: theme.statusColors.in_progress.text,
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.avatarSection}>
          ...
          <Text style={styles.roleTypeLabel}>Technician</Text>
